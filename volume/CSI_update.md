...
| 版本            | 更新时间   | 更新内容                                                     |
|-----------------| ---------- | ------------------------------------------------------------ |
| **26.08.19**    | 2026.08.19 | rssd 支持加密盘|
| **se26.07.07**  | 2026.07.07 | 修复 uhost 售罄情况下 udisk 调度失败的问题|
| **26.06.03**    | 2026.06.03 | 1. 新增us3fs mounter支持，通过`--mounter=us3fs`启用<br>2. s3fs进程segfault崩溃时自动重新挂载 |
| **se26.05.06**  | 2026.05.06 | 修复有状态pod漂移时在部分可用区可能出现的调度错误问题 |
| **se26.04.09**  | 2026.04.09 | 修复大规模集群中udisk pvc可能调度失败的问题 |
| **26.02.28**    | 2026.02.28 | s3fs 默认挂载参数中移除`curldbg`选项，减少系统日志量 |
