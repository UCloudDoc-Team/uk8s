...
> Nginx Ingress较低版本存在一些安全漏洞，详见[Ingress-Nginx Controller漏洞公告](/uk8s/vulnerability/CVE-2025-1974.md), 如果您的 Kubernetes 版本在1.13 - 1.25并且需要安装Nginx Ingress，建议以最小权限管理Nginx Ingress。
