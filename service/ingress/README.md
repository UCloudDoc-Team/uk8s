...
alb ingress 使用 ucloud alb 实现的ingress的一个控制器，请参考 [ALB Ingress](/uk8s/service/ingress/alb_ingress.md)。

## Nginx Ingress

官方在2026年3月[停止维护](https://kubernetes.io/zh-cn/blog/2025/11/11/ingress-nginx-retirement/)
