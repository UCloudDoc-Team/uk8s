...
```
kubectl apply -f https://raw.githubusercontent.com/UCloudDocs/uk8s/master/yaml/ingress_treafik/mandatory.yaml
```
...
```
kubectl apply -f https://raw.githubusercontent.com/UCloudDocs/uk8s/master/yaml/ingress_treafik/Service.yaml
```
...
```
kubectl apply -f https://raw.githubusercontent.com/UCloudDocs/uk8s/master/yaml/ingress_treafik/ui.yaml
```
