...
```
kubectl apply -f https://raw.githubusercontent.com/UCloudDocs/uk8s/master/yaml/cicd/yaml_jenkins_jenkins-pvc.yaml
```

3、 以Deployment方式部署Jenkins master,为了演示方便，我们还使用LoadBalancer类型的service将其暴露到外网。

```
kubectl apply -f https://raw.githubusercontent.com/UCloudDocs/uk8s/master/yaml/cicd/yaml_jenkins_jenkins.yaml
```
...
```
kubectl apply -f https://raw.githubusercontent.com/UCloudDocs/uk8s/master/yaml/cicd/yaml_jenkins_jenkins-rbac.yaml
```
